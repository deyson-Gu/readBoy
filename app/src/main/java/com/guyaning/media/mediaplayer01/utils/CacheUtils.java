...
public class CacheUtils {
    ...
    public static void putPlaymode(Context context,String key,int values){
        SharedPreferences sharedPreferences = context.getSharedPreferences("mediaPlayer",Context.MODE_PRIVATE);
    ...
    public static int getPlaymode(Context context,String key){
        SharedPreferences sharedPreferences = context.getSharedPreferences("mediaPlayer",Context.MODE_PRIVATE);
        return sharedPreferences.getInt(key, MusicPlayService.PLAYMODE_NORMAL);
    }
